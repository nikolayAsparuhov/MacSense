...
Drop the following PNGs here, ~1280×800 each, captured on a Mac with the dark
theme MacSense uses by default:

| File                    | What to capture                                                              |
|-------------------------|-------------------------------------------------------------------------------|
| `hero.png`              | Main window, Cleanup tab, after a Smart Scan with results                    |
| `cleanup.png`           | Cleanup grid showing several category cards with sizes                       |
| `storage-bubbles.png`   | Storage → Size tab, drilled into a folder, bubble map populated              |
